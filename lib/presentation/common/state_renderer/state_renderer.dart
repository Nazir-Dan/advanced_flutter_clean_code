...
class StateRenderer extends StatelessWidget {
    ...
    switch (stateRendererType) {
      ...
      case StateRendererType.popupErrorState:
        return _getPopUpDialog(context, [
          ...
          _getMessage(message),
          _getRetryButton(AppStrings.ok.tr(), retryActionFunction, context)
        ]);
      ...
      case StateRendererType.fullScreenErrorState:
        return _getItemsColumn([
          _getAnimatedImage(JsonAssets.error),
          _getMessage(message),
          _getRetryButton(AppStrings.retryAgain.tr(), retryActionFunction, context)
        ]);
  ...
  Widget _getRetryButton(
      String buttonTitle, Function retryActionFunction, BuildContext context) {
    return Center(
      child: Padding(
